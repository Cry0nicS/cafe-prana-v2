  ...
  messages: {
    en: {
      ...
      event: {
        ...
        viewEvent: 'View event',
        backToEvents: 'Events',
        passed: 'This gathering has passed.',
        everyGathering: 'Every gathering',
      ...
      reservations: {
        ...
        form: {
          ...
          hoursUnavailable: 'Our booking times cannot be loaded right now, so no time can be offered. Please email {email} and I will reserve your table.',
    ...
    de: {
      ...
      event: {
        ...
        backToEvents: 'Events',
        passed: 'Diese Zusammenkunft ist vorbei.',
        everyGathering: 'Jede Zusammenkunft',
        dietary: 'Vegan · Glutenfrei · Bio',
        more: 'Weitere Events',
      ...
      reservations: {
        ...
        form: {
          ...
          hoursUnavailable: 'Unsere Buchungszeiten können gerade nicht geladen werden, daher lässt sich keine Uhrzeit anbieten. Schreibe bitte an {email}, dann reserviere ich deinen Tisch.',
